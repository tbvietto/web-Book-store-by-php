    ...
    <div style="background-color: white;">
        ...
        <div style="text-align: center; padding: 15px; clear: both">
            ...
            if ($current_page > 1 && $total_page > 1){
                echo '<a href="search_detail.php?pageDetail='.($current_page-1) . '&s=' . $_GET['s'] . '&searchAuthor=' . $_GET['searchAuthor'] . '&searchISBN=' . $_GET['searchISBN'] . '&searchPublisher=' . $_GET['searchPublisher'] . '&searchLang=' . $_GET['searchLang'] . '&price=' . $_GET['price'] . '&ava=' . $_GET['ava'] . '">Prev</a> | ';
            }
            for ($i = 1; $i <= $total_page; $i++){
                if ($i == $current_page){
                    ...
                    echo '<a href="search_detail.php?pageDetail='.$i . '&s=' . $_GET['s'] . '&searchAuthor=' . $_GET['searchAuthor'] . '&searchISBN=' . $_GET['searchISBN'] . '&searchPublisher=' . $_GET['searchPublisher'] . '&searchLang=' . $_GET['searchLang'] . '&price=' . $_GET['price'] . '&ava=' . $_GET['ava'] . '">'.$i.'</a> | ';
                }
            }
            if ($current_page < $total_page && $total_page > 1){
                echo '<a href="search_detail.php?pageDetail='.($current_page+1) . '&s=' . $_GET['s'] . '&searchAuthor=' . $_GET['searchAuthor'] . '&searchISBN=' . $_GET['searchISBN'] . '&searchPublisher=' . $_GET['searchPublisher'] . '&searchLang=' . $_GET['searchLang'] . '&price=' . $_GET['price'] . '&ava=' . $_GET['ava'] . '">Next</a>';
            }
            ?>
        </div>
